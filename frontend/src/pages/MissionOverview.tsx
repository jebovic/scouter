  ...
  return (
    <main className={styles.main}>
      <div className="container">
        ...
        <div className={styles.section}>
          <PriceDropWatchlist missionId={mission.id} />
        </div>
